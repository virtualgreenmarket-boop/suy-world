...
const EMOJI_BUILDERS = {
  laugh_tears: (headG) => {
    ...
    const eyeL = B(0.2,0.08,0.05,M('#111')); eyeL.name='emo_eyeL'; eyeL.position.set(-0.24,0.1,0.56); eyeL.rotation.z=-0.15; headG.add(eyeL);
    const eyeR = B(0.2,0.08,0.05,M('#111')); eyeR.name='emo_eyeR'; eyeR.position.set(0.24,0.1,0.56); eyeR.rotation.z=0.15; headG.add(eyeR);
    const tearL = B(0.06,0.12,0.05,M('#4FC3F7')); tearL.name='emo_tearL'; tearL.position.set(-0.24,0.0,0.56); headG.add(tearL);
    const tearR = B(0.06,0.12,0.05,M('#4FC3F7')); tearR.name='emo_tearR'; tearR.position.set(0.24,0.0,0.56); headG.add(tearR);
    const mouthBg = B(0.34,0.16,0.05,M('#880000')); mouthBg.name='emo_mouthBg'; mouthBg.position.set(0,-0.2,0.56); headG.add(mouthBg);
    const teeth = B(0.3,0.06,0.06,M('#ffffff')); teeth.name='emo_teeth'; teeth.position.set(0,-0.14,0.57); headG.add(teeth);
    const mL = B(0.1,0.1,0.04,M('#880000')); mL.name='emo_mL'; mL.position.set(-0.17,-0.2,0.56); mL.rotation.z=0.5; headG.add(mL);
    const mR = B(0.1,0.1,0.04,M('#880000')); mR.name='emo_mR'; mR.position.set(0.17,-0.2,0.56); mR.rotation.z=-0.5; headG.add(mR);
  ...
  wink: (headG) => {
    // One eye closed (line), other eye normal, slight smile
    const eyeL = B(0.18,0.04,0.05,M('#111')); eyeL.name='emo_eyeL'; eyeL.position.set(-0.24,0.1,0.56); headG.add(eyeL);
    const eyeR = B(0.09,0.09,0.06,M('#111')); eyeR.name='emo_eyeR'; eyeR.position.set(0.24,0.1,0.56); headG.add(eyeR);
    const smileC = B(0.12,0.06,0.04,M('#cc3333')); smileC.name='emo_smileC'; smileC.position.set(0,-0.22,0.56); headG.add(smileC);
    const smileL = B(0.08,0.06,0.04,M('#cc3333')); smileL.name='emo_smileL'; smileL.position.set(-0.09,-0.19,0.56); smileL.rotation.z=0.3; headG.add(smileL);
    const smileR = B(0.08,0.06,0.04,M('#cc3333')); smileR.name='emo_smileR'; smileR.position.set(0.09,-0.19,0.56); smileR.rotation.z=-0.3; headG.add(smileR);
  },
  ...
  yummy: (headG) => {
    ...
    const eyeL = B(0.2,0.08,0.05,M('#111')); eyeL.name='emo_eyeL'; eyeL.position.set(-0.24,0.1,0.56); eyeL.rotation.z=-0.15; headG.add(eyeL);
    const eyeR = B(0.2,0.08,0.05,M('#111')); eyeR.name='emo_eyeR'; eyeR.position.set(0.24,0.1,0.56); eyeR.rotation.z=0.15; headG.add(eyeR);
    const tongue = B(0.12,0.18,0.06,M('#E91E63')); tongue.name='emo_tongue'; tongue.position.set(0.08,-0.28,0.57); tongue.rotation.z=-0.2; headG.add(tongue);
    const mouth = B(0.14,0.08,0.04,M('#880000')); mouth.name='emo_mouth'; mouth.position.set(0,-0.20,0.56); headG.add(mouth);
  },
  ...
  shh: (headG) => {
    ...
    const eyeL = B(0.09,0.09,0.06,M('#111')); eyeL.name='emo_eyeL'; eyeL.position.set(-0.24,0.1,0.56); headG.add(eyeL);
    const eyeR = B(0.09,0.09,0.06,M('#111')); eyeR.name='emo_eyeR'; eyeR.position.set(0.24,0.1,0.56); headG.add(eyeR);
    const mouth = B(0.08,0.08,0.06,M('#111')); mouth.name='emo_mouth'; mouth.position.set(0,-0.20,0.56); headG.add(mouth);
    // Hand gesture (simplified as rectangle near mouth)
    const hand = B(0.16,0.10,0.05,M('#FFCC99')); hand.name='emo_hand'; hand.position.set(0.22,-0.15,0.58); hand.rotation.z=-0.3; headG.add(hand);
  },
  ...
  shake_no: (headG, group) => {
    ...
    const shakeInterval = setInterval(() => {
      ...
      if (group?.userData?.parts?.headG) {
        group.userData.parts.headG.rotation.y = Math.sin(shakeTime * 15) * 0.3;
      }
    }, 50);
  ...
  nod_yes: (headG, group) => {
    ...
    const nodInterval = setInterval(() => {
      ...
      if (group?.userData?.parts?.headG) {
        group.userData.parts.headG.rotation.x = Math.sin(nodTime * 12) * 0.25;
      }
    }, 50);
  ...
  angry: (headG) => {
    ...
    const browL = B(0.2,0.07,0.05,M('#8B0000')); browL.name='emo_browL'; browL.position.set(-0.24,0.22,0.56); browL.rotation.z=-0.5; headG.add(browL);
    const browR = B(0.2,0.07,0.05,M('#8B0000')); browR.name='emo_browR'; browR.position.set(0.24,0.22,0.56); browR.rotation.z=0.5; headG.add(browR);
    const eyeL = B(0.14,0.06,0.05,M('#cc0000')); eyeL.name='emo_eyeL'; eyeL.position.set(-0.24,0.1,0.56); headG.add(eyeL);
    const eyeR = B(0.14,0.06,0.05,M('#cc0000')); eyeR.name='emo_eyeR'; eyeR.position.set(0.24,0.1,0.56); headG.add(eyeR);
    const mouthC = B(0.14,0.07,0.04,M('#555')); mouthC.name='emo_mouthC'; mouthC.position.set(0,-0.26,0.56); headG.add(mouthC);
    const mouthL = B(0.1,0.07,0.04,M('#555')); mouthL.name='emo_mouthL'; mouthL.position.set(-0.11,-0.22,0.56); mouthL.rotation.z=0.4; headG.add(mouthL);
    const mouthR = B(0.1,0.07,0.04,M('#555')); mouthR.name='emo_mouthR'; mouthR.position.set(0.11,-0.22,0.56); mouthR.rotation.z=-0.4; headG.add(mouthR);
  },
  ...
  crying: (headG) => {
    ...
    const eyeL = B(0.08,0.08,0.06,M('#111')); eyeL.name='emo_eyeL'; eyeL.position.set(-0.24,0.06,0.56); headG.add(eyeL);
    const eyeR = B(0.08,0.08,0.06,M('#111')); eyeR.name='emo_eyeR'; eyeR.position.set(0.24,0.06,0.56); headG.add(eyeR);
    const tearL1 = B(0.05,0.14,0.05,M('#4FC3F7')); tearL1.name='emo_tearL1'; tearL1.position.set(-0.24,-0.02,0.56); headG.add(tearL1);
    const tearR1 = B(0.05,0.14,0.05,M('#4FC3F7')); tearR1.name='emo_tearR1'; tearR1.position.set(0.24,-0.02,0.56); headG.add(tearR1);
    const tearL2 = B(0.04,0.1,0.05,M('#4FC3F7')); tearL2.name='emo_tearL2'; tearL2.position.set(-0.24,-0.18,0.56); headG.add(tearL2);
    const tearR2 = B(0.04,0.1,0.05,M('#4FC3F7')); tearR2.name='emo_tearR2'; tearR2.position.set(0.24,-0.18,0.56); headG.add(tearR2);
    const mouth = B(0.22,0.05,0.04,M('#555')); mouth.name='emo_mouth'; mouth.position.set(0,-0.24,0.56); mouth.rotation.z=0; headG.add(mouth);
  }
};
