...
const EMOJI_BUILDERS = {
  ...
  wink: (headG) => {
    ...
    smileL.position.set(-0.09,-0.19,0.56);
  ...
  yummy: (headG) => {
    ...
    tongue.position.set(0.08,-0.28,0.57);
