...
export function initLevelDisplay() {
  ...
  container.innerHTML = `
    <div class="level-badge">
      <div id="player-level-display" class="level-number">1</div>
    </div>
    <div class="exp-bar-container">
      <div class="exp-bar-background">
        <div id="player-exp-bar" class="exp-bar-fill"></div>
        <div id="player-exp-text" class="exp-bar-text">0/10</div>
      </div>
    </div>
  `;
...
export function updateLevelDisplay() {
  ...
  expText.textContent = `${currentExp}/${requiredForNextLevel}`;
